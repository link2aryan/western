      	...
      	<form class="bor" method="post" action="log.php">
        	<div class="form-group">
          	...
          	<div class="form-group">
	            ...
	            <input type="text" class="form-control" name="userName" id="exampleInputEmail1" placeholder="Username" width="auto" required>
          	</div>
          	<div class="form-group">
	  ...
	  <div class="container-fluid">
	    ...
	    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	      <ul class="nav navbar-nav">
	        ...
	        <li >
	        	<a href="mailto:milan.khanal@studentpartner.com?Subject=Query%20|%20westernNepal">
	        		Contact Us
	        	</a>
	        </li>
	      </ul>
